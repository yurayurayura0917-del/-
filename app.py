...
# 地図
    ...
    for mdata in st.session_state.memories:
        ...
        iframe = folium.IFrame(html=html, width=250, height=420)
 ...
 # 一覧
    ...
    for m in filtered:
        ...
        st.markdown(
        f"""<div style="background:#fff; border-radius:14px; margin:10px 0; overflow:hidden; box-shadow:0 2px 6px rgba(0,0,0,0.08);">
        {img_html}
